...
class PayrollAfp(models.TransientModel):
    ...
    head_bank = ["Empleado", "Apellidos Paterno", "Apellidos Materno", "Nombres", 
                "CodAsegurado", "NroCi", "Ext", "Cargo", "DiasTrabajados", "Ingreso", "Anios", "Porcentaje",
                "Basico", "Bono Antiguedad", "Otros Haberes", "TotalGanado", "RCIVA",
                "AFP", "Aporte Solidario", "AFP NACIONAL SOLIDARIO", "Prestamos Anticipos",
                "Otros Descuentos", "TotalDescuentos", "Liquido Pagable",
    ...
    def get_payroll(self, data):
        ...
        if(len(lines_rciva) > 0):
            ...
            dfcont = dfi.filter(['Empleado', 'Paterno', 'Materno', 'Nombres', 'CodAsegurado', 'NroCi',
                                ...
                                'OtrosIngresos', 'TotalGanado', 'RC13_IVA', 'AporteAFP',
                                'AFP_SOL_0_5', 'AFP_SOL_MAY', 'PrestamoAnticipo', 'OtrosDesc', 'TotalDesc',
