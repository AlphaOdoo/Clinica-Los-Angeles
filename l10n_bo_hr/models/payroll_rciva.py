...
class PayrollRciva(models.TransientModel):
    ...
    head_RCIVA = ["Empleado", "Año", "Periodo", "Código Dependiente", "Apellidos y Nombres", "Ap. Paterno", "Ap. Materno", "Nombres",
                  "Nro CI", "Tipo Doc.", "Novedades",
                  "Haber Basico", "Bono Antiguedad", "Otros Haberes", "TotalGanado", "Descuentos de Ley", "TOTAL SUELDO", "OTROS INGRESOS", "SUELDO NETO", "MINIMO NO IMPONIBLE",
                  "DIF.SUJETA A IMPUESTO", "13% IVA", "13% 2MN", "ImpPagar", "Form 110 DECL.JUR", "SALDO A/F FISCO", "SALDO A/F DEPENDT.",
                  "SALDO ANTERIOR", "ACTUALIZACION", "SALDO TOTAL", "SALDO TOTAL DEP.", "SALDO UTILIZADO", "IMPUESTO RETENIDO",
                  "SALDO SIG.MES"
                  ]
    ...
    def get_payroll_RCIVA(self, data):
        ...
        if(len(lines_rciva) > 0):
            ...
            dfcont = dfi.filter(['Empleado', 'Anios', 'Mes', 'CodDependiente',
                                 ...
                                 'OtrosHaberes', 'TotalGanado', 'DescLey', 'TotalSueldo','OtrosIngresos', 'SueldoNeto', 'MinimoNoImponible_',
