...
class PayrollMinistry(models.TransientModel):
    ...
    head_bank = ["Nro", "Tipo de Documento de Identidad", "Nro de Documento de Identidad",
                 "Lugar de expiración", "Fecha de Nacimiento",
                 "Apellido Paterno", "Apellido Materno", "Nombres",
                 "Pais de Nacionalidad", "Sexo", "Jubilado", "Aport AFP?",
                 "Persona con Discapacidad?", "Tutor de persona con Discapacidad",

                 "Fecha Ingreso", "Fecha de Retiro", "Motivo Retiro",
                 "Caja de Salud", "AFP aporta", "NUA/CUA", "Sucursal adicional",
                 "Clasificacion laboral", "Cargo",

                 "Modalidad de Contrato", "Tipos Contrato", "Dias Pagados", "Horas Pagadas",
                 "Haber Basico", "Bono Antiguedad", "Horas extra", "Monto Horas Extra",
                 "Horas Recargo nocturno",
                 "Monto Horas Extra Nocturnas", "Horas Extra Dominicales",
                 "Monto Horas Extra Dominicales", "Domingos Trabajados",
    ...
    def get_payroll(self, data):
        ...
        SELECT distinct emp.id as Empleado, 
            emp.doc_type as TipoDocIdentidad,
            emp.identification_id as NroDoc, 
            emp.ci_ext as LugarExpedicion,
			COALESCE(cast((TO_CHAR(emp.birthday, 'DD/MM/YYYY')) as TEXT), ' ') AS FechaNac,
            emp.paternal_surname as Paterno, 
            emp.maternal_surname as Materno, 
            emp.all_name AS Nombres,
            cont.name as NombreCiudad, 
	    CASE 
        ...
        if(len(lines) > 0):
            ...
            dfcont = dfi.filter(['Empleado', 'TipoDocIdentidad', 'NroDoc', 'LugarExpedicion', 'FechaNac',
                                'Paterno', 'Materno', 'Nombres', 'NombreCiudad', 'gender',
                                 ...
                                 'OtrosBonosPagos','RC13_IVA', 'CNS', 'AporteAFP', 'OtrosDesc'])
